...
const DestinationTypeNames: Record<string, string> = {
...
export function formatDestination(value: DestinationType | number | string | undefined | null): string {
  if (value === undefined || value === null) return 'Unknown';

  if (typeof value === 'string') {
    // 1. Check mapping for enum names, normalized names, or already formatted names
    if (DestinationTypeNames[value]) return DestinationTypeNames[value];
  ...
  switch (value) {
    case DestinationType.DESTINATION_UNSPECIFIED: return 'Unknown';
    case DestinationType.DESTINATION_STRAVA: return 'Strava';
    case DestinationType.DESTINATION_SHOWCASE: return 'Showcase';
    case DestinationType.DESTINATION_HEVY: return 'Hevy';
    case DestinationType.DESTINATION_TRAININGPEAKS: return 'TrainingPeaks';
    case DestinationType.DESTINATION_INTERVALS: return 'Intervals.icu';
    case DestinationType.DESTINATION_GOOGLESHEETS: return 'Google Sheets';
    case DestinationType.DESTINATION_GITHUB: return 'GitHub';
    case DestinationType.DESTINATION_MOCK: return 'Mock';
    default: return 'Unknown';
  }
}

const DestinationTypeValues: Record<string, DestinationType> = {
    'destination_unspecified': DestinationType.DESTINATION_UNSPECIFIED,
    'unspecified': DestinationType.DESTINATION_UNSPECIFIED,
    'unknown': DestinationType.DESTINATION_UNSPECIFIED,
    '0': DestinationType.DESTINATION_UNSPECIFIED,
    'destination_strava': DestinationType.DESTINATION_STRAVA,
    'strava': DestinationType.DESTINATION_STRAVA,
    '1': DestinationType.DESTINATION_STRAVA,
    'destination_showcase': DestinationType.DESTINATION_SHOWCASE,
    'showcase': DestinationType.DESTINATION_SHOWCASE,
    '2': DestinationType.DESTINATION_SHOWCASE,
    'destination_hevy': DestinationType.DESTINATION_HEVY,
    'hevy': DestinationType.DESTINATION_HEVY,
    '3': DestinationType.DESTINATION_HEVY,
    'destination_trainingpeaks': DestinationType.DESTINATION_TRAININGPEAKS,
    'trainingpeaks': DestinationType.DESTINATION_TRAININGPEAKS,
    '4': DestinationType.DESTINATION_TRAININGPEAKS,
    'destination_intervals': DestinationType.DESTINATION_INTERVALS,
    'intervals': DestinationType.DESTINATION_INTERVALS,
    'intervals.icu': DestinationType.DESTINATION_INTERVALS,
    '5': DestinationType.DESTINATION_INTERVALS,
    'destination_googlesheets': DestinationType.DESTINATION_GOOGLESHEETS,
    'googlesheets': DestinationType.DESTINATION_GOOGLESHEETS,
    'google sheets': DestinationType.DESTINATION_GOOGLESHEETS,
    '6': DestinationType.DESTINATION_GOOGLESHEETS,
    'destination_github': DestinationType.DESTINATION_GITHUB,
    'github': DestinationType.DESTINATION_GITHUB,
    '7': DestinationType.DESTINATION_GITHUB,
    'destination_mock': DestinationType.DESTINATION_MOCK,
    'mock': DestinationType.DESTINATION_MOCK,
    '99': DestinationType.DESTINATION_MOCK,
};

export function parseDestination(input: string | number | undefined | null): DestinationType {
  if (input === undefined || input === null) return DestinationType.DESTINATION_UNSPECIFIED;
  const key = String(input).toLowerCase().trim();
  if (DestinationTypeValues[key] !== undefined) return DestinationTypeValues[key];
  return DestinationType.DESTINATION_UNSPECIFIED;
}
...
export function formatActivitySource(value: ActivitySource | number | string | undefined | null): string {
  ...
  switch (value) {
    case ActivitySource.SOURCE_UNSPECIFIED: return 'Unspecified';
...
const ActivitySourceValues: Record<string, ActivitySource> = {
    'source_unspecified': ActivitySource.SOURCE_UNSPECIFIED,
    'unspecified': ActivitySource.SOURCE_UNSPECIFIED,
    '0': ActivitySource.SOURCE_UNSPECIFIED,
...
export function parseActivitySource(input: string | number | undefined | null): ActivitySource {
  if (input === undefined || input === null) return ActivitySource.SOURCE_UNSPECIFIED;
  const key = String(input).toLowerCase().trim();
  if (ActivitySourceValues[key] !== undefined) return ActivitySourceValues[key];
  return ActivitySource.SOURCE_UNSPECIFIED;
}
...
export function formatExecutionStatus(value: ExecutionStatus | number | string | undefined | null): string {
  ...
  switch (value) {
    case ExecutionStatus.STATUS_UNSPECIFIED: return 'Unspecified';
...
const ExecutionStatusValues: Record<string, ExecutionStatus> = {
    'status_unspecified': ExecutionStatus.STATUS_UNSPECIFIED,
    'unspecified': ExecutionStatus.STATUS_UNSPECIFIED,
    '0': ExecutionStatus.STATUS_UNSPECIFIED,
...
export function parseExecutionStatus(input: string | number | undefined | null): ExecutionStatus {
  if (input === undefined || input === null) return ExecutionStatus.STATUS_UNSPECIFIED;
  const key = String(input).toLowerCase().trim();
  if (ExecutionStatusValues[key] !== undefined) return ExecutionStatusValues[key];
  return ExecutionStatus.STATUS_UNSPECIFIED;
}
